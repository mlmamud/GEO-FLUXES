...
artifacts, are exclusively owned by the author.
...
Any commercial use, redistribution, sublicensing, or incorporation into paid
services, products, or consulting deliverables requires explicit written
...
- **FEHM** (Los Alamos National Laboratory)  
- **MODFLOW** (U.S. Geological Survey)  
- **VS2DI / VS2DTI (VS2DRTI)** (U.S. Geological Survey)  
